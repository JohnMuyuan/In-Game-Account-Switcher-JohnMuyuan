...
![游戏内账号切换器截图 1](docs/images/1.png)

![游戏内账号切换器截图 2](docs/images/2.png)

![游戏内账号切换器截图 3](docs/images/3.png)

![游戏内账号切换器截图 4](docs/images/4.png)

![游戏内账号切换器截图 5](docs/images/5.png)

![游戏内账号切换器截图 6](docs/images/6.png)
...
```text
build/libs/IAS-9.0.7-johnmuyuan.2+<Minecraft版本>-<loader>.jar
```
