...
repositories {
    ...
    maven("https://api.modrinth.com/maven/") { // ModMenu fallback mirror.
...
dependencies {
    ...
    if (modmenu.startsWith('$')) {
        compileOnly("maven.modrinth:modmenu:${modmenu.substring(1)}")
    } else {
