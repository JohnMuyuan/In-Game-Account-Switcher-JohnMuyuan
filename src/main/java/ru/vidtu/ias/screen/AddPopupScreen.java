...
final class AddPopupScreen extends Screen {
    ...
    protected void init() {
        ...
        PopupButton button = new PopupButton(this.width / 2 - 75, this.height / 2 - 24, 150, 20, Component.translatable("ias.add.microsoft"), btn -> {
            Screen next = new GlobalPasswordPopupScreen(this.parent, this.handler);
            //$set_screen 'this.minecraft' 'next'
    ...
    /*public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {*/
        ...
        //? if >=26.1 {
        graphics.centeredText(this.font, this.title, this.width / 2, this.height / 2 - 45, 0xFF_FF_FF_FF);
        //?} else
        /*graphics.drawCenteredString(this.font, this.title, this.width / 2, this.height / 2 - 45, 0xFF_FF_FF_FF);*/
    }
