...
final class LoginPopupScreen extends Screen implements LoginHandler {
    ...
    protected void init() {
        ...
        if (this.passFuture != null) {
            // Add password box.
            this.password = new PopupBox(this.font, this.width / 2 - 100, this.height / 2 - 10 + 5, 178, 20, this.password, Component.translatable("ias.globalPassword.unlock"), () -> {
            ...
            // Create tip.
            this.cryptPasswordTip = MultiLineLabel.create(this.font, Component.translatable("ias.globalPassword.unlock.tip").withColor(0xFF_FF_00), 320);
        }
    }
    ...
    /*public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {*/
        ...
        //? if >=26.1 {
        graphics.centeredText(this.font, this.title, this.width / 2, this.height / 2 - 70, 0xFF_FF_FF_FF);
        //?} else
        /*graphics.drawCenteredString(this.font, this.title, this.width / 2, this.height / 2 - 70, 0xFF_FF_FF_FF);*/
