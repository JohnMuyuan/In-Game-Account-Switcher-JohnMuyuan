...
public final class IASStorage {
    static final String STORAGE_PATH = "_IAS_ACCOUNTS_DO_NOT_SEND_TO_ANYONE/.hidden/accounts_v1.do_not_send_to_anyone";
    ...
    public static void load(@NotNull Path path) {
        try {
            ...
            Path file = path.resolve(STORAGE_PATH);
    ...
    public static void save(@NotNull Path path) {
        try {
            ...
            // Write the data.
            Files.write(temporary, data, StandardOpenOption.CREATE,
                    StandardOpenOption.TRUNCATE_EXISTING, StandardOpenOption.WRITE,
                    StandardOpenOption.SYNC, StandardOpenOption.DSYNC, LinkOption.NOFOLLOW_LINKS);
            try {
