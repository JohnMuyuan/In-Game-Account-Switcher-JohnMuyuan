        ...
        try {
            ...
            this.server.createContext("/", ex -> {
                try {
                    ...
                    // Rethrow.
                    this.handler.error(new RuntimeException("Unexpected exception on '/'.", t));
                }
            });
            ...
            this.server.createContext("/end", ex -> {
                try {
                    ...
                    // Rethrow.
                    this.handler.error(new RuntimeException("Unexpected exception on '/end'.", t));
                }
            });
        ...
        try {
            ...
            CompletableFuture.supplyAsync(() -> {
                ...
                if (!this.state.equals(state)) {
                    throw new IllegalStateException("OAuth state validation failed.");
                }
