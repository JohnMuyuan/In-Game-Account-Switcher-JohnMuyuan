...
If this page doesn't help, report the issue in this edited version's GitHub repository. Do not post account files, tokens, passwords, or unredacted logs publicly.
...
You've entered the wrong global password, or the local password vault is damaged.
Try entering the global password again. If it has been forgotten, the encrypted account data cannot be recovered; remove the password vault and add the accounts again.
